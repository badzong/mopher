...
dblog_init(void)
{
	...
	scheme = vlist_scheme("dblog",
		...
		"milter_envrcpt_addr",		VT_STRING,	VF_KEEPNAME,
		"milter_recipients",		VT_INT,		VF_KEEPNAME,
		"milter_recipient_list_str",	VT_STRING,	VF_KEEPNAME,
		"milter_message_size",		VT_INT,		VF_KEEPNAME,
		"milter_queueid",		VT_STRING,	VF_KEEPNAME,
		"milter_message_id",		VT_STRING,	VF_KEEPNAME,
